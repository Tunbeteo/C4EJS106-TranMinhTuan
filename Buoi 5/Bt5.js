...
// let task = {
//     subject : 'implenment login feature',
//     createdBy:'Hoang Ngoc Duc',
//     assignTo:'Nguyen Phuong Nam ',
//     dueDate:'2019-10-08T180:00:24+0000',
//     expectedHours:0.5,
// };
// var {dueDate,subject, assignTo} = task;
// console.log(task)

// 3
// 3.1 Kiểu dữ liệu object
//3.2 Array object
// 
// let jobHit = {
//     hits:[  {
...
// ]
// }
// console.log(jobHit.hits);
// for(let key of jobHit.hits){
//     console.log(key.skills)
//     console.log(key.jobRequirement)
//     console.log(key.jobTitle)
//     console.log(key.benefits)
//     console.log(key.jobSalary)
// }
...
//     if(Object.keys(data).includes(key)==true){
//         alert(`${key} \n ${data[key]}`);
//         break
//     }else{
//         let newkey=prompt(`we could not find your keyword:${key}leave your explantion`);
//         alert('done')
//         data[key]=newkey;
//     }
// }
...
for(let key in products){
     keys=Number(key)+1;
    console.log('...................................');
    console.log(`#${keys} Name:${products[key].name}  \n Price:${ products[key].price} `);
}
let user=Number(prompt('Enter product position'));
for (let key in products){
    if (user == Number(key)+1){
        console.log(` Name:${products[key].name} \n Brand:${products[key].brand} \n Price:${products[key].price} \n Color:${products[key].color} \n category:${products[key].category}`);
    }
}
let user=prompt('Enter your category: ').toLowerCase();
for(let value of products){
    if(user==(value.category.toLowerCase())){
        console.log('......................');
